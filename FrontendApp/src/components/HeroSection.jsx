...
const HeroSection = () => {
  ...
  return (
    <div className='flex flex-col h-screen items-start justify-center gap-4 px-6 md:px-16 lg:px-36 
    bg-[url("/backgroundImage.png")] bg-cover bg-center'>

      <img src={assets.marvelLogo} alt='marvel logo' className='max-h-11 lg:h-11 mt-20' />

      <h1 className='text-5xl md:text-[70px] leading-16 font-semibold max-w-110'>Guardians <br /> of the Galaxy</h1>
      ...
      <div className='flex items-center text-gray-300 gap-4'>
        ...
        <div className='flex items-center gap-1'>
          <TimerIcon className='w-4.5 h-4.5' />2h 18m
        </div>
