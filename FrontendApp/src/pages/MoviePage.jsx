...
import { CloudAlertIcon, Heart, PlayCircleIcon, StarIcon } from 'lucide-react'
...
const MoviePage = () => {
  ...
  const getShowDetails = async () => {
    const showFound = dummyShowsData.find((show) => show._id === id)
  ...
  return show ? (
    ...
    <div>No shows Details Available <CloudAlertIcon /></div>
  )
